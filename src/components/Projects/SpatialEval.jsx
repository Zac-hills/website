      ...
      <div>
        ...
        >
          ...
          <p className="article-text">
            ...
            when it comes to their use. The current standard for depicting a convolutional neural network's 
            capability has a dependency on the dataset that was used to train and test it. For example, this convolutional neural network has a
            ...
            dimensional environment. For example, questions such as at what
            distance does the network start to lose accuracy, what are the weak
            view points such as the front or back of the object, and how well does
          ...
          <p className="article-text">
            ...
            of a convolutional neural network. I am not stating that the previous
            ...
            network. However, once the network is fully trained and the
            ...
            convolutional neural network models, one network for objects that are closer and another for
          ...
          <p className="article-text" style={{ marginTop: "100px" }}>
            ...
            composite of multiple fly bys with a distance of 10, 15, 20, and
            25m from the object. The angle of incidence is represented, where
            the 0 degree is true north. The object's front should face true north to better calculate the angle of incidence relative to the 
            object's rotation, for objects that are symmetrical this is not mandatory.
            <img
